...
from Image_Pool_model import ImagePool, DSA_ImagePool
from dataloader.tf_dataloader_API import TFDataLoader
from callbacks import SaveHistory, update_train_history
from loss import combined_generator_loss, combined_discriminator_loss
...
class Training:
    ...
    def train(self, NumEpochs, batch_size=1, sample_interval=10):
        ...
        @tf.function
        def train_G(imgs_A, imgs_B, dsl_pool):
        ...
        def train_on_batch(image_A, image_B):
            fake_B, fake_A, g_loss_per_batch_tmp = train_G(image_A, image_B, self.dsl_pool)
