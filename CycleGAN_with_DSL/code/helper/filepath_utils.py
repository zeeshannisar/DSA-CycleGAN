import glob
import os
from helper import config_utils_segmentation as config_utils
import argparse
import fnmatch
import re
...
class FilepathGenerator:
    ...
    def get_segmented_folder(self, label, folderPath=None):
        ...
        if folderPath is None:
            folderPath= self.config['evaluate.segmentationpath']
    ...
    def get_threshold_folder(self, label):
        ...
        return self.get_segmented_folder(label, self.config['evaluate.threscomppath'])
