...
## Acknowledgements
This work is funded by ANR HistoGraph (ANR-23-CE45-0038) and ArtIC project ``Artificial Intelligence for Care'' (ANR-20-THIA-0006-01), co-funded by Région Grand Est, Inria Nancy – Grand Est, IHU Strasbourg, University of Strasbourg & University of Haute-Alsace. We acknowledge the ERACoSysMed & e:Med initiatives by BMBF, SysMIFTA (managed by PTJ, FKZ 031L-0085A; ANR, grant ANR-15-CMED-0004), Prof. Cédric Wemmert, and the team at MHH for the high-quality images & annotations: N. Kroenke, N. Schaadt, V. Volk & J. Schmitz. We thank Nvidia, the Centre de Calcul (University of Strasbourg) & GENCI-IDRIS (grant 2020-A0091011872) for GPU access.
