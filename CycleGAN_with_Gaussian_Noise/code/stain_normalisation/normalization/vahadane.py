...
from stain_normalisation.normalization.normalizer_abc import FancyNormalizer
from stain_normalisation.utils import misc_utils as mu
import stain_normalisation.spams
...
class VahadaneNormalizer(FancyNormalizer):
    ...
    def __init__(self, **kwargs):
        super(VahadaneNormalizer, self).__init__(**kwargs)
